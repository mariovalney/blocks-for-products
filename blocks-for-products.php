 ...
 * Text Domain:     blocks-for-products
...
if ( ! class_exists( 'Blocks_For_Products' ) ) {

    class Blocks_For_Products {
        ...
        public function on_activation() {
            do_action( 'bfp_on_core_activation' );
        ...
        public function load_plugin_textdomain() {
            load_plugin_textdomain( BFP_TEXTDOMAIN, false, basename( dirname( __FILE__ ) ) . '/languages/' );
        }
        ...
        public function run() {
            ...
            define( 'BFP_PLUGIN_DIR', dirname( BFP_PLUGIN_BASENAME ) );
            define( 'BFP_PLUGIN_URL', plugins_url( '', __FILE__ ) );

            // Definition of text domain
            if ( ! defined( 'BFP_TEXTDOMAIN' ) ) {
                define( 'BFP_TEXTDOMAIN', 'blocks-for-products' );
            }
            ...
            foreach ( $this->modules as $module_slug => $module ) {
                ...
                if ( property_exists( $module, 'includes' ) ) {
                    foreach ( (array) $module->includes as $class ) {
                        $file = BFP_PLUGIN_PATH . '/modules/' . $module_slug . '/includes/' . $class . '.php';
                        if ( file_exists( $file ) ) {
                            require_once $file;
                        }
                    }
